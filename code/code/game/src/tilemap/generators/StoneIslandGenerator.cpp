...
namespace WorldExtender {
	std::vector<int> StoneIslandGenerator::generateChunk() {
	...
	std::vector<int> StoneIslandGenerator::defineTileVersions(std::vector<int> island) {
		std::vector<int> versionedIsland(WIDTH * HEIGHT, 0);
